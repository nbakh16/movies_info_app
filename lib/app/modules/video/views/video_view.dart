        ...
        return Padding(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _controller == null ? const ContainerShimmerLoading() :
              Card(
                color: mainColor,
  ...
  Column trailerInfo(BuildContext context, int index) {
    return Column(
      children: [
        ...
        Text('${videoController.videosList[index].name}',
          style: Theme.of(context).textTheme.titleMedium,
        ),
        Text('${videoController.videosList[index].publishedAt?.split('T').first}',
